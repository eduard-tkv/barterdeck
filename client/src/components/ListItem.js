                ...
                <div className="form login-form">
                  <form className="form-horizontal" id="list-item" onSubmit={ this.submitForm }>
                    <div className="form-group">
                      ...
                      <div>
                        <input required type="text" className="form-control" name="item-offered" 
                    ...
                    <div className="form-group">
                      ...
                      <div>          
                        <input required type="text" className="form-control" name="item-sought" 
                    ...
                    <div className="form-group">
                      ...
                      <textarea required className="form-control" rows="10" name="description"
